                        ...
                        index_t stride_c)
{
   ...
   hipLaunchKernelGGL(( naive_gemm_kernel<ADataType, BDataType, AccDataType, CDataType, LayoutA, LayoutB, LayoutC>)
        , dim3(numBlocks), dim3(numThreadsPerBlock), 0, 0, 
                                  ...
                                  float* scale_B_ptr)
{
   ...
   hipLaunchKernelGGL(( blockwise_gemm_kernel<ADataType, BDataType, AccDataType, CDataType, LayoutA, LayoutB, LayoutC>)
        , dim3(numBlocks), dim3(numThreadsPerBlock), 0, 0, a_ptr,
                                            b_ptr,
                                            c_ptr,
                                            M,
                                            N,
                                ...
                                index_t batch_count)
{
    ...
    for(index_t batch_id = 0; batch_id < batch_count; ++batch_id)
    {
       ...
       hipLaunchKernelGGL(( naive_gemm_kernel<ADataTypeCompute,
                          BDataTypeCompute,
                          AccDataType,
                          CDataType,
                          LayoutA,
                          LayoutB,
                          LayoutC>), dim3(numBlocks), dim3(numThreadsPerBlock), 0, 0, 
